...
/* Consolidated JS File */

/* Source: /mnt/data/bootstrap.min.js */
/*!
...
/* Source: /mnt/data/Lightbox-Gallery-baguetteBox.min.js */
/*!
 * baguetteBox.js
 * @author  feimosi
 * @version 1.11.1
...
particlesJS('particles-js', {
    particles: {
        ...
        line_linked: { enable: true, distance: 150, color: '#faf3e0', opacity: 0.4, width: 1 },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    lightGalleryElements.forEach((el) => {
        lightGallery(el, {
            mode: 'lg-slide',
            speed: 600,
            cssEasing: 'ease',
